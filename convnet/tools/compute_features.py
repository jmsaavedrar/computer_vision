...
if __name__ == '__main__':
    ...
    parser.add_argument("-list", type=str, help=" <optional>, a list of images", required = True)    
    parser.add_argument("-batch_size", type=int, help=" <optional>, size of the batch used for prediction", required = False)    
    parser.add_argument("-odir", type=str, help=" path where data is saved", required = True)    
    ...
    features = faster_predictor.get_deep_features(filenames[0])
    ...
    for item in filenames:        
        ...
        deep_features = faster_predictor.get_deep_features(item)
